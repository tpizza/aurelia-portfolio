...
define('main',['exports', './environment'], function (exports, _environment) {
  ...
  function configure(aurelia) {
    aurelia.use.standardConfiguration().plugin('aurelia-validation').plugin('aurelia-animator-css').feature('resources');
...
define('work/work-landing',['exports'], function (exports) {
	...
	var WorkLanding = exports.WorkLanding = function WorkLanding() {
		_classCallCheck(this, WorkLanding);
...
define('resources/elements/forms/contact-form',['exports', 'aurelia-framework', 'aurelia-dependency-injection', 'aurelia-validation', '../../renderers/validation-renderer'], function (exports, _aureliaFramework, _aureliaDependencyInjection, _aureliaValidation, _validationRenderer) {
  ...
  var ContactForm = exports.ContactForm = (_dec = (0, _aureliaDependencyInjection.inject)(_aureliaValidation.ValidationControllerFactory), _dec2 = (0, _aureliaFramework.customElement)('contact-form'), _dec(_class = _dec2(_class = function () {
    function ContactForm(controllerFactory) {
      _classCallCheck(this, ContactForm);

      this.nature = [{ id: 0, name: 'Inquiry' }, { id: 1, name: 'Request' }];
      this.contactMethod = [{ id: 0, name: 'Email' }, { id: 1, name: 'Phone' }];
    ...
    ContactForm.prototype.activateRules = function activateRules() {
      ...
      _aureliaValidation.ValidationRules.customRule('Mouthoff', function (value, obj) {
      ...
      _aureliaValidation.ValidationRules.ensure(function (ContactForm) {
        ...
        return email;
      }).email().required().when(function (ContactForm) {
        return _this.preferredContact === 'Email';
      }).on(this);
    };

    ContactForm.prototype.submit = function submit() {

      var errors = this.controller.validate();

      errors.then(function (v) {
        if (v.length === 0) {
          console.info('nada');
        } else {
          console.info('error');
